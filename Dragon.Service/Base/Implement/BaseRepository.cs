...
namespace Dragon.Service.Base.Implement
{
    /// <summary>
    ...
    public class BaseRepository<T> : IBaseRepository<T>
    {
        ...
        /// <summary>
        /// 初始化连接对象 Database=39.107.116.113;Data Source=Dragon;User Id=dachao123;Password=dachao123;port=3306;
        /// </summary>
        ...
        /// 增加一条数据 返回id
        /// </summary>
        public int Add(T model, IDbTransaction transaction = null, int? commandTimeout = default(int?))
        {
            int? result;
        ...
        /// 根据ID删除一条数据
        /// </summary>
        public bool Delete(int id, IDbTransaction transaction = null, int? commandTimeout = default(int?))
        {
            int? result;
            using (_connection = OpenConnection())
            {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(T model, IDbTransaction transaction = null, int? commandTimeout = default(int?))
        {
            int? result;
            using (_connection = OpenConnection())
            {
                result = _connection.Update<T>(model, transaction, commandTimeout);
            }
            if (result > 0)
            {
                return true;
        ...
        /// 根据ID获取实体对象
        /// </summary>
        public T GetModel(int id, IDbTransaction transaction = null, int? commandTimeout = default(int?))
        {
            using (_connection = OpenConnection())
            {
