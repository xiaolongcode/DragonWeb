...
namespace Dragon.Service.Base.Interface
{
    ...
    public interface ICommonRepository
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        ResultView GetModel<T>(int id, IDbTransaction transaction = null, int? commandTimeout = default(int?));
        /// <summary>
        /// 获取列表数据 
        /// </summary>
        /// <returns></returns>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        ResultView Delete<T>(int id, IDbTransaction transaction = null, int? commandTimeout = default(int?));
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        ResultView Update<T>(T entity, IDbTransaction transaction = null, int? commandTimeout = default(int?));
