...
namespace Dragon.Service.Base.Interface
{
    /// <summary>
    /// 接口层Device
    /// </summary>
    public interface IBaseRepository<T>
    {
        ...
        /// 增加一条数据
        /// </summary>
        int Add(T model, IDbTransaction transaction = null, int? commandTimeout = default(int?));
        /// <summary>
        /// 根据ID删除一条数据
        /// </summary>
        bool Delete(int Id, IDbTransaction transaction = null, int? commandTimeout = default(int?));
        /// <summary>
        /// 根据条件删除数据
        /// </summary>
        /// <returns></returns>
        ...
        /// 更新一条数据
        /// </summary>
        bool Update(T model, IDbTransaction transaction = null, int? commandTimeout = default(int?));
        /// <summary>
        /// 根据sql获取实体对象
        /// </summary>
        ...
        /// 根据ID获取实体对象
        /// </summary>
        T GetModel(int Id, IDbTransaction transaction = null, int? commandTimeout = default(int?));
